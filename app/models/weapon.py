...
class Weapon(db.Model):
    ...
    profile_1_special_rules= db.relationship("weapon_special_rule", back_populates="weapon") 
    profile_1_critical_rules= db.relationship("weapon_critical_rule", back_populates="weapon") 
    profile_2_special_rules= db.relationship("weapon_special_rule", back_populates="weapon") 
    profile_2_critical_rules= db.relationship("weapon_critical_rule", back_populates="weapon") 
    profile_3_special_rules= db.relationship("weapon_special_rule", back_populates="weapon") 
    profile_3_critical_rules= db.relationship("weapon_critical_rule", back_populates="weapon") 
